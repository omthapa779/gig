...
const notifications = [
  {
    ...
    detail: "Your proposal for UI/UX Designer was viewed.",
    time: "Mar 19, 2025",
    status: "unread",
  },
  {
    id: "NT-398",
    title: "New message",
    detail: "A company sent a message in Landing Redesign chat.",
    time: "Mar 15, 2025",
    status: "read",
  },
  {
    ...
    detail: "Your payout of $320.00 is completed.",
    time: "Mar 09, 2025",
    status: "read",
  },
];
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-2">
            Review alerts, messages, and payout updates.
          </p>
        </div>
        <button
          onClick={() => navigate(-1)}
