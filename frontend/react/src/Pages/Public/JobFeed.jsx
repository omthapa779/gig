    ...
    const visible = useMemo(() => {
        ...
        return jobs.filter((job) => {
            ...
            if (activeFilter !== "All") {
                ...
                else if (activeFilter === "On-Site") passFilter = job.isPhysical;
                else if (activeFilter === "Local/Physical") {
                    passFilter = normalize(job.category) === normalize("Local / Physical Labor");
                }
                else {
                    // Check for robust match
                    const target = normalize(activeFilter);
                    const jobCat = normalize(job.category);
                    passFilter = jobCat === target || jobCat.includes(target) || target.includes(jobCat);
                }
            }
